...
if __name__ == "__main__":
    ...
    df = np.load(data_folder+'/netflix_ratings.dat')
    ratings = df
    ...
    for k in matrix_factors:
        ...
        train_mse.dump(output_folder + 'train_mse_netflix_factor_'+str(k)+'.dat')
        test_mse.dump(output_folder + 'test_mse_netflix_factor_'+str(k)+'.dat')
        test_hr.dump(output_folder + 'test_hr_netflix_factor_'+str(k)+'.dat')
        test_precision.dump(output_folder + 'test_precision_netflix_factor_'+str(k)+'.dat')
    
    print("Done for Netflix!")
