...
if __name__ == "__main__":
    ...
    df = np.load(data_folder+'/yahoo_movie_ratings.dat')
    ratings = df
    ...
    for k in matrix_factors:
        ...
        train_mse.dump(output_folder + 'train_mse_yahooMovies_factor_'+str(k)+'.dat')
        test_mse.dump(output_folder + 'test_mse_yahooMovies_factor_'+str(k)+'.dat')
        test_hr.dump(output_folder + 'test_hr_yahooMovies_factor_'+str(k)+'.dat')
        test_precision.dump(output_folder + 'test_precision_yahooMovies_factor_'+str(k)+'.dat')
    
    print("Done for Yahoo! movies.")
